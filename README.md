...
**Note**：This project is fully generated by ChatGPT-Pro and only for research purpose. The prompt is "I want to build a demo for industry partners, the demo is a medical conversation assistant which can helps you to make some diagnosis and provide suggestions, the demo should be accessible from the Internet, show me the solution".
